...
//Don't touch me!
//#Add
recipes.addShaped(<eplus:advanced_table>, [[<minecraft:gold_block>, <minecraft:writable_book>, <minecraft:gold_block>],[<minecraft:obsidian>, <mekanism:controlcircuit:1>, <minecraft:obsidian>], [<minecraft:obsidian>, <minecraft:obsidian>, <minecraft:obsidian>]]);
recipes.addShaped(<wearablebackpacks:backpack>, [[<minecraft:leather>, <ore:twine>, <minecraft:leather>],[<minecraft:leather>, <ore:wool>, <minecraft:leather>], [<minecraft:leather>, <minecraft:leather>, <minecraft:leather>]]);
